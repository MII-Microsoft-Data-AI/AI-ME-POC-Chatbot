...
import { useHitlOptional } from "@/components/assistant-ui/CustomLanggraphRuntime";
...
const ToolFallbackImpl: ToolCallMessagePartComponent = ({
  ...
  const {
    ...
    argsDraftTextById: {},
    setArgsDraftText: () => undefined,
    resetArgsDraftText: () => undefined,
    argsDraftErrorById: {},
    allDecided: false,
    allApprovedArgsValid: false,
    submitDecisions: () => undefined,
    toolResults: {},
    argsDisplayTextById: {},
  };
  ...
  }, [hitl, storedResult, result, aui]);

  const hint = hitl && isInterruptTool
    ? decision === "approved"
      ? "Approved"
      : decision === "rejected"
        ? "Rejected"
  ...
  return (
    ...
    >
      ...
      <ToolFallbackContent>
        ...
        {hitl && isInterruptTool && !isCancelled ? (
          <div className="px-4">
        ...
        {hitl && isInterruptTool ? (
          <div className="flex flex-col gap-2 px-4">
            ...
            {decision === "rejected" && result === undefined ? (
              <p className="text-muted-foreground text-xs">This tool call will not run.</p>
            ) : null}
