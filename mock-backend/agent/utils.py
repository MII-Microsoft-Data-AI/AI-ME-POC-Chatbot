...
from lib.blob import get_file_base64, get_file_temporary_link
...
def process_image_url_item(item: dict, use_base64: bool = True) -> dict:
    """
            ...
            if attachment:
                ...
                if use_base64:
                    ...
                    return {
                        "type": "image_url",
                        "image_url": {
                            "url": base_64_compiled,
                        },
                    }
                else:
                    blob_url = get_file_temporary_link(
